...
function csmm_linkback() {
  ...
  if ($tmp[0] < '4') {
    $out .= 'Create stunning <a href="' . csmm_generate_web_link('show-love-create-stunning') . '" target="_blank">coming soon pages for WordPress</a>. Completely free.';
  } elseif ($tmp[0] < '8') {
    $out .= 'Create <a href="' . csmm_generate_web_link('show-love-create-free') . '" target="_blank">free maintenance mode pages for WordPress</a> like this one in under a minute.';
  } elseif ($tmp[0] < 'c') {
    $out .= 'Join more than 60,000 happy people using the <a href="' . csmm_generate_web_link('show-love-join-60k') . '" target="_blank">free Coming Soon &amp; Maintenance Mode plugin for WordPress</a>.';
  } else {
    $out .= 'Create free <a href="' . csmm_generate_web_link('show-love-create-free') . '" target="_blank">maintenance mode pages for WordPress</a>.';
  }
  $out .='</p></div>';
