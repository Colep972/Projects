...
GameFight::GameFight(SDL_Renderer* renderer, SDL_Texture* textureArray[NB_IMAGE], Bridge* bridge) : Scene(renderer, textureArray), m_bridge(bridge), player(Player_c,true), ennemy()
{
    //Background
    ...
    //Battle sprites
    m_tabSprite.push_back(new Sprite(m_renderer, m_textureArray[24], 50,100,4*78,4*40));
    m_tabSprite.push_back(new Sprite(m_renderer, m_textureArray[23], 450,100,4*78,4*40));
...
GameFight::GameFight(): Scene(m_renderer,m_textureArray)
{
    //cstr
}
...
void GameFight::update(Input* input)
{
    ...
    {
       // Updating sprite
        m_tabSprite[11]->setTexture(m_textureArray[24]);
        m_tabSprite[12]->setTexture(m_textureArray[m_bridge->ennemyBoat->getTypeBoat()*2+25]);
...
//        Mix_PlayMusic(test_music2, -1 );
 ...
 // If Pause Button is Pressed
    ...
    else
    {
        ...
        player = Battleship(Player_c,true);
        //m_tabSprite.push_back(new Sprite(m_renderer, m_textureArray[43],0,0,800,500));
    }
}
...
void GameFight::render()
{
    ...
    toolbox::Write("C:/Users/joaki/OneDrive/Documents/GameJam/Alakajam/data/police.ttf",18,m_police,255,255,255,m_renderer,pseudo," Life : ",object,120,80,0,0);
    toolbox::Write("C:/Users/joaki/OneDrive/Documents/GameJam/Alakajam/data/police.ttf",18,m_police,255,255,255,m_renderer,"Ennemy Life :",object2,120,80,580,0);
    if (Turn)
    {
        toolbox::Write("C:/Users/joaki/OneDrive/Documents/GameJam/Alakajam/data/police.ttf",18,m_police,255,255,255,m_renderer,pseudo," Turn ",100,80,550,360);
        toolbox::Write("C:/Users/joaki/OneDrive/Documents/GameJam/Alakajam/data/police.ttf",18,m_police,255,255,255,m_renderer,"Stamina : ",object3,100,80,550,420);
    }
    else
    {
        toolbox::Write("C:/Users/joaki/OneDrive/Documents/GameJam/Alakajam/data/police.ttf",18,m_police,255,255,255,m_renderer,"Ennemy Turn : ",100,80,450,380);
        toolbox::Write("C:/Users/joaki/OneDrive/Documents/GameJam/Alakajam/data/police.ttf",18,m_police,255,255,255,m_renderer,action,90,80,550,380);
    }
}

bool GameFight::Finish()
{
    if (End)
    {
        return true;
